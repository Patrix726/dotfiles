...
export PATH=$PATH:$HOME/.spicetify:$HOME/Documents/Scripts:$HOME/.local/bin:$HOME/.local/share/bin/hyde-scripts:$GOPATH/bin:~/.console-ninja/.bin:~/.opencode/bin:~/.cargo/bin
